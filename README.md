...
With the Pay. plugin you can easily add different payment methods to your CS-Cart webshop. Go to [Pay](https://www.pay.nl) for an overview of all our features and services, or visit [docs](https://docs.pay.nl/plugins#cs-cart) for more information.
...
Version 2.0.0 of the CS-Cart plugin introduces significant changes to the payment processing. After upgrading, please review your settings.
A new required setting called "Token Code" has been added.
If this option is missing after upgrading, uninstall and reinstall the plugin from the CS-Cart admin panel. This will restore the setting, but it will also reset your payment methods, so make sure to note your current settings first.
