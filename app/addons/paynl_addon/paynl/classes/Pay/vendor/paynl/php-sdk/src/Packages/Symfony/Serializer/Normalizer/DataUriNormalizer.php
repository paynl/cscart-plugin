...
use PayNL\Sdk\Packages\Symfony\HttpFoundation\File\File;
use PayNL\Sdk\Packages\Symfony\HttpFoundation\File\MimeType\MimeTypeGuesser;
use PayNL\Sdk\Packages\Symfony\HttpFoundation\File\MimeType\MimeTypeGuesserInterface as DeprecatedMimeTypeGuesserInterface;
use PayNL\Sdk\Packages\Symfony\Mime\MimeTypeGuesserInterface;
use PayNL\Sdk\Packages\Symfony\Mime\MimeTypes;
...
class DataUriNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    ...
    public function denormalize($data, $type, $format = null, array $context = [])
    {
        ...
        throw new InvalidArgumentException(sprintf('The class parameter "%s" is not supported. It must be one of "SplFileInfo", "SplFileObject" or "Symfony\HttpFoundation\File\File".', $type));
    }
